import {
   Insert_Client_Motorbike,
   Select_Client_Motorbike_Id,
   Select_Client_Motorbike_All,
   Update_Client_Motorbike,
   Delete_Client_Motorbike,
} from '../models/client_motorbike.controllers.js'
