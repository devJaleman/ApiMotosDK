import {
   Insert_Client_Direction,
   Select_Client_Direction_Id,
   Select_Client_Direction_All,
   Update_Client_Direction,
   Delete_Client_Direction,
} from '../models/client_direction.controllers.js'
